...
ego lite は現在 macOS に対応しており、Windows 版はまもなくベータ版が公開される予定です。Linux は[ロードマップ](https://lite.ego.app/roadmap)にあります。
