    ...
    if (typeof expression === "function") {
        ...
        if (!hasWarnedAboutFunctionJs) {
            ...
            process.stderr.write(`[ego-browser] js() received a function and auto-wrapped it (${jsSnippet(source, 80)}).\n` +
                ...
                `    elementEval(target, fn, ...args)        // function + args, via Runtime.callFunctionOn\n`);
        }
        expression = `(${source})()`;
    }
 ...
 * @param {{button?: "left"|"middle"|"right", clickCount?: number, clicks?: number}} [options]
 ...
 * @param {MouseTarget} target CSS selector, @ref, viewport point, or selector-relative point.
 * @param {{button?: "left"|"middle"|"right"}} [options]
 * @returns {Promise<void>}
 */
 ...
 * @param {{button?: "left"|"middle"|"right", delayMs?: number}} [options]
 * @returns {Promise<void>}
 */
 ...
 */
async function fill(selectorOrRef, value) {
 ...
 * @returns {Promise<object>}
 */
async function type(selectorOrRef, text, options = {}) {
...
export { INTERNAL_URL_PREFIXES, NAME, __testing, captureScreenshot, cdp, click, currentTab, dispatchKey, doubleClick, dragMouse, drainEvents, elementCenter, elementEval, ensureRealTab, fill, fillInput, gotoAndWait, gotoUrl, helperContext, hover, httpGet, iframeTarget, installEgoSdk, js, learnContext, listTabs, loadAgentHelpers, newTab, openOrReuseTab, pageInfo, pressKey, runMain, runSiteBrowserTool, runSiteTool, scroll, scrollBy, scrollToBottomUntil, siteSkills, siteSkillsForUrl, snapshot, snapshotRaw, snapshotText, switchTab, taskSpaces, type, typeText, uploadFile, useOrCreateTaskSpace, wait, waitForElement, waitForLoad, waitForNetworkIdle };
